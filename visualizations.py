...
def plot_lego_vs_star_wars_overall(db_filename="starwars.db"):
    ...
    ax1.text(
        0,
        lego_avg_pieces + lego_avg_pieces * 0.03,
    ...
    bars = ax2.bar(
        labels, scores, color=colors, edgecolor="black", linewidth=1.5, zorder=3
    )
    ...
    plt.tight_layout()
    plt.savefig(
        "visualizations/lego_vs_star_wars_overall.png", dpi=300, bbox_inches="tight"
    )
    print("[OK] Saved: lego_vs_star_wars_overall.png")
    plt.show()
