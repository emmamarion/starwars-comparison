...
def plot_star_wars_rating_differences(db_filename="starwars.db"):
    ...
    bars = ax.bar(range(len(movies)), differences, color=colors, 
    ...
    ax.set_ylabel('Rating Difference (IMDb - Rotten Tomatoes)', fontsize=13, fontweight='bold')
    ax.set_title('Star Wars: Do Audiences and Critics Agree?\n' + 
    ...
    plt.tight_layout()
    plt.savefig('star_wars_rating_differences.png', dpi=300, bbox_inches='tight')
...
def plot_star_wars_vs_all_averages(db_filename="starwars.db"):
    ...
    bars1 = ax1.bar(categories, imdb_scores, color=colors_imdb, 
                    edgecolor='black', linewidth=2, width=0.6, alpha=0.9)
    ...
    bars2 = ax2.bar(categories, rt_scores, color=colors_rt, 
                    edgecolor='black', linewidth=2, width=0.6, alpha=0.9)
    ax2.set_ylabel('Average Rotten Tomatoes Score (0-100)', fontsize=12, fontweight='bold')
    ax2.set_title('Rotten Tomatoes Scores\n(Critic Scores)', fontsize=14, fontweight='bold')
    ax2.set_ylim(0, 100)
    ...
    plt.tight_layout()
    plt.savefig('star_wars_vs_all_averages.png', dpi=300, bbox_inches='tight')
...
def plot_top_movies_with_star_wars_highlighted(db_filename="starwars.db"):
    ...
    bars = ax.barh(range(len(titles)), avg_ratings, color=colors, 
                    edgecolor='black', linewidth=1.5, alpha=0.85)
...
if __name__ == "__main__":
    ...
    # Comics visualization (if you want to test it separately)
